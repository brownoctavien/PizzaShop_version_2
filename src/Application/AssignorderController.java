...
public class AssignorderController
{
    ...
    {
        if (saleType_cbox.getValue() != null && pizzaSize_cbox.getValue() != null
                && topping_cbox.getValue() != null && !quantity_txt.getText().isEmpty()
                && !name_txt.getText().isEmpty() && orderCount<=1 ) {
            orderCount = 1;
            ...
            alert.setContentText("Customer name: "+ Customer.getName()
                    + " with an id of "+ Customer.getID() + " and an order ID of "
                    + OrderInfo.getID()+ " was added");
            alert.showAndWait();
